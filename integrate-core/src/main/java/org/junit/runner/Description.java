...
public class Description implements Serializable {
    ...
    public static Description createTestDescription(Class<?> clazz, String name, Annotation... annotations) {
        ...
        if (clazz.getName().endsWith("__ProxyTest__")) {
            displayName = displayName.substring(0, displayName.lastIndexOf("__ProxyTest__"));
        }
        return new Description(clazz, formatDisplayName(name, displayName), annotations);
    }
