package com.integrate.admin.service.system.user;
...
public class AdminUserService {
	...
	*通过id获取数据
	*/
	public AdminUser getUserAndRoleById(String USER_ID) throws Exception {
		return (AdminUser) dao.findForObject("UserMapper.getUserAndRoleById", USER_ID);
	}
