package com.integrate.admin.controller.system.login;
...
import com.integrate.admin.entity.system.Role;
import com.integrate.admin.service.system.menu.MenuService;
import com.integrate.admin.service.system.role.RoleService;
...
import com.integrate.admin.util.DateUtil;
import com.integrate.admin.util.PageData;
import com.integrate.admin.util.RightsHelper;
import com.integrate.admin.util.Tools;
...
public class LoginController extends BaseController {
	...
	public ModelAndView toLogin()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("SYSNAME", SYSTEM_NAME); //读取系统名称
	...
	public ModelAndView login_index(@PathVariable("changeMenu") String changeMenu){
		...
		try{
			...
			AdminUser user = (AdminUser)session.getAttribute(Const.SESSION_USER);
			if (user != null) {
				
				AdminUser userr = (AdminUser)session.getAttribute(Const.SESSION_USERROL);
				if(null == userr){
				...
				if(null == session.getAttribute(Const.SESSION_allmenuList)){
					...
					logger.warn("菜单列表："+allmenuList.toString());
