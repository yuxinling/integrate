...
<body>
		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="bg/proportionList.do" method="post" name="Form"
						id="Form">
						...
						<table id="table_report"
							...
							<thead>
								<tr>
									...
									<th style="width: 35%;height:30px;font-size: 15px" class="center">固定比例设置</th>
									<th style="width: 35%;font-size: 15px" class="center">赠送比例设置</th>
									<th style="width: 30%;font-size: 15px" class="center">重新设置</th>
							...
							<tbody>
								...
								<tr>
									...
									<td style="width: 35%;font-size: 20px;height:30px;" class="center">${p.fixed}天</td>

									<td style="width: 35%;font-size: 20px" class="center">${p.give}天</td>
									<td style="width: 30%;" class="center">
									<a style="cursor: pointer;" title="编辑"
											onclick="edit('${p.fixed}','${p.give}');" class="tooltip-success"
	...
	<script type="text/javascript">
		...
		//修改
		function edit(fixed,give){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = '<%=basePath%>bg/proportionToEdit.do?fixed='+fixed+'&give='+give;
			 diag.Width = 600;
			 diag.Height = 305;
