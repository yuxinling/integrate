...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="bg/rechargeList.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
					<span class="input-icon">
						<input autocomplete="off" id="nav-search-input" type="hidden" name="type" value="0" placeholder="这里输入昵称" />
				<span class="input-icon" >
							...
							<c:forEach items="${varList}" var="var" varStatus="vs">
								<tr>
									...
									<td style="width: 5%;" class="center">
									  <a style="cursor: pointer;" title="积分调整" onclick="edit('${var.id}','${var.name}','${var.money}');" class="tooltip-success" 
									  		data-rel="tooltip" title="" data-placement="left">
											<span class="green"><i class="icon-edit"></i></span>
									  </a>&nbsp;
									  <a style="cursor: pointer;" title="冻结订单" onclick="editFreeze('${var.id}','${var.isFreeze }');" class="tooltip-success"
											data-rel="tooltip" title="" data-placement="left">
											<span class="green"><i class="icon-tint"></i></span>
									  </a>
									</td>
	...
	<!-- 日期框 -->
		...
		function edit(id,name,money){
			//修改
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = "<%=basePath%>bg/rechrageToEdit.do?id="+id+"&name="+name+"&money="+money+"&tm="+new Date().getTime();
			 diag.Width = 600;
			 diag.Height = 305;
